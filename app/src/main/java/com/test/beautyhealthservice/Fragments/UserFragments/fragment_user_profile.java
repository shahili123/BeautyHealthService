...
import com.test.beautyhealthservice.BeautySpecialistHomePage;
...
import com.test.beautyhealthservice.RegisterActivity;
import com.test.beautyhealthservice.UserHomePage;
            ...
            public void onClick(View v) {
                ...
                if(txt_email.getEditText().getText().toString().equals("")){
                    ...
                    if(flag_image){
                        ...
                        databaseReference.child(Helper.GetData(getActivity(),"user_id")).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() != null) {
                    ...
                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                        ...
                        txt_full_name.getEditText().setText(childSnapshot.child("full_name").getValue(String.class));
                        txt_address.getEditText().setText(childSnapshot.child("address").getValue(String.class));

                        Picasso.get().load(childSnapshot.child("image_url").getValue(String.class)).into(user_image);
